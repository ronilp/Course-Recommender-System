...
% Last Modified by GUIDE v2.5 29-Oct-2014 22:34:27
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.text3,'String','Getting training data!!');
[filename pathname] = uigetfile('*.txt');
fpath=strcat(pathname,filename);
set(handles.text1,'String',fpath);
set(handles.text3,'String','Training data loaded!! Enter course list now');
text=load(fpath);
text;
c=num2cell(text);
...
y=get(handles.text2,'String');
varargout{1} = get(handles.text1,'String');
varargout{2} = get(handles.text2,'String');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.text3,'String','Getting Course list!!');
[filename pathname] = uigetfile('*.txt');
fpath=strcat(pathname,filename);
set(handles.text2,'String',fpath);
set(handles.text3,'String','DATA OBTAINED!! Close window to continue');
